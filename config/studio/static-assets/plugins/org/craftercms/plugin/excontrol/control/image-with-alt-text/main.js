CStudioForms.Controls.imageWithAltText = CStudioForms.Controls.imageWithAltText ||
...
YAHOO.extend(CStudioForms.Controls.imageWithAltText, CStudioForms.CStudioFormField, {
  ...
  render: function (config, containerEl) {
    ...
    altEl.value = this.escapeContent ? CStudioForms.Util.unEscapeXml(this.form.model.logo2_alt) : this.form.model.logo2_alt;
    this.altEl = altEl;
...
CStudioAuthoring.Module.moduleLoaded("image-with-alt-text", CStudioForms.Controls.imageWithAltText);
