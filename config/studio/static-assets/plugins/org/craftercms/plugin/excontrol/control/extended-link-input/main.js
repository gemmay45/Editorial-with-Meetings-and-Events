...
YAHOO.extend(CStudioForms.Controls.extendedLinkInput, CStudioForms.CStudioFormField, {
  ...
  createDialog: function () {
    ...
    newdiv.innerHTML =
      '<div class="tox-dialog__content-js" id="dialog-describe_1045515932251703821073939"><div class="tox-dialog__body"><div class="tox-dialog__body-content"><div class="tox-form"><div class="tox-form__group" aria-disabled="false"><label class="tox-label" for="form-field_5845808142161703821073937">URL</label><div class="tox-form__controls-h-stack"><div class="tox-control-wrap" aria-disabled="false"><input type="url" aria-errormessage="aria-invalid_324411591591703820709200" role="combobox" aria-autocomplete="list" aria-haspopup="true" tabindex="-1" data-alloy-tabstop="true" class="tox-textfield" aria-expanded="false" id="form-field_5845808142161703821073937"><div class="tox-control-wrap__status-icon-wrap"><div title="invalid" aria-live="polite" id="aria-invalid_324411591591703820709200" class="tox-icon tox-control-wrap__status-icon-invalid"><svg width="24" height="24"><path d="M19.8 18.3c.2.5.3.9 0 1.2-.1.3-.5.5-1 .5H5.2c-.5 0-.9-.2-1-.5-.3-.3-.2-.7 0-1.2L11 4.7l.5-.5.5-.2c.2 0 .3 0 .5.2.2 0 .3.3.5.5l6.8 13.6zM12 18c.3 0 .5-.1.7-.3.2-.2.3-.4.3-.7a1 1 0 00-.3-.7 1 1 0 00-.7-.3 1 1 0 00-.7.3 1 1 0 00-.3.7c0 .3.1.5.3.7.2.2.4.3.7.3zm.7-3l.3-4a1 1 0 00-.3-.7 1 1 0 00-.7-.3 1 1 0 00-.7.3 1 1 0 00-.3.7l.3 4h1.4z" fill-rule="evenodd"></path></svg></div></div></div><button title="URL" type="button" data-alloy-tabstop="true" tabindex="-1" class="tox-button tox-button--icon tox-button--naked tox-browse-url"><span class="tox-icon tox-tbtn__icon-wrap"><svg width="24" height="24"><path d="M19 4a2 2 0 012 2v12a2 2 0 01-2 2h-4v-2h4V8H5v10h4v2H5a2 2 0 01-2-2V6c0-1.1.9-2 2-2h14zm-8 9.4l-2.3 2.3a1 1 0 11-1.4-1.4l4-4a1 1 0 011.4 0l4 4a1 1 0 01-1.4 1.4L13 13.4V20a1 1 0 01-2 0v-6.6z" fill-rule="nonzero"></path></svg></span></button></div></div><div class="tox-form__group" aria-disabled="false"><label class="tox-label" for="form-field_116006432171703821073937">Text to display</label><input type="text" tabindex="-1" data-alloy-tabstop="true" class="tox-textfield" id="form-field_116006432171703821073937"></div><div class="tox-form__group" aria-disabled="false"><label class="tox-label" for="form-field_7921667532181703821073937">Title</label><input type="text" tabindex="-1" data-alloy-tabstop="true" class="tox-textfield" id="form-field_7921667532181703821073937"></div><div class="tox-form__group" aria-disabled="false"><label class="tox-label" for="form-field_3123462832191703821073937">Open link in...</label><div class="tox-listboxfield"><button title="Open link in..." aria-label="Open link in..." aria-haspopup="true" type="button" data-alloy-tabstop="true" unselectable="on" tabindex="-1" class="tox-listbox tox-listbox--select" aria-expanded="false" data-value="" id="form-field_3123462832191703821073937" style="user-select: none;"><span class="tox-listbox__select-label">Current window</span><div class="tox-listbox__select-chevron"><svg width="10" height="10"><path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 010-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fill-rule="nonzero"></path></svg></div></button></div></div></div></div></div></div>';
