  ...
  */
  ...
  createDialog: function () {
    ...
    newdiv.innerHTML =
      ...
      '<label class="tox-label" for="url">URL</label>' +
      '<div class="tox-form__controls-h-stack">' +
      '<div class="tox-control-wrap" aria-disabled="false">' +
      '<input type="url" aria-errormessage="aria-invalid_526777492591703822075552" role="combobox" aria-autocomplete="list" aria-haspopup="true" tabindex="-1" data-alloy-tabstop="true" class="tox-textfield" aria-expanded="false" id="url">' +
