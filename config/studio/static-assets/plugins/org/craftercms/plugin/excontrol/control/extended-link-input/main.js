...
YAHOO.extend(CStudioForms.Controls.extendedLinkInput, CStudioForms.CStudioFormField, {
  ...
  createDialog: function () {
    ...
    newdiv.innerHTML =
      ...
      '<button title="URL" type="button" data-alloy-tabstop="true" tabindex="-1" class="tox-button tox-button--icon tox-button--naked tox-browse-url btn-default yui-button" style="box-shadow: none;">' +
    ...
    var titleEl = upload_dialog.getElementById('tox-dialog_h');
