...
YAHOO.extend(CStudioForms.Controls.extendedLinkInput, CStudioForms.CStudioFormField, {
  ...
  createDialog: function () {
    ...
    newdiv.innerHTML =
      ...
      '<div role="dialog" aria-modal="true" tabindex="-1" class="tox-dialog" aria-labelledby="dialog-label_362831062241703822078255" aria-describedby="dialog-describe_8249867402251703822078255" style="position: relative;">' +
      ...
      '<button title="URL" type="button" data-alloy-tabstop="true" tabindex="-1" class="tox-button tox-button--icon tox-button--naked tox-browse-url">' +
