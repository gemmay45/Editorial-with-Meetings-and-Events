...
<div class="single-card-layout-content-wrapper">
    ...
    <div class="single-card-layout-content">Technology plays a key role in pretty much every one of our business get togethers these days.&nbsp; That’s why Nina has invested in the most up to date hardware, and why our tech team is always on standby to connect you and keep you tuned in.</div>
...
<script src="/scripts/nina/playVideo.js"></script>    </div>
</div>