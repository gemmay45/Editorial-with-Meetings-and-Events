...
<div class="component scwl-promo module-component single-card-wrapper need-to-control-bg col-12" style=${contentModel.theme_s!""}>
...
<div class="single-card-bottom-wrapper">
                ...
                <li tabindex="-1" class="uk-active">
                    <div class="uk-card uk-card-default custom-slider-card">
                        <div class="uk-card-media-top custom-slider-card-media-top">
                            <@crafter.img $field="image_s" class="m-image lazyload-img" alt="" width="609" height="376" src=(contentModel.image_s!"") />
                        </div>
                    </div>
                </li>
    ...
    <div class="single-card-content-wrapper">
        <h3 class="single-card-content-title"><@crafter.tag $tag="font" $field="contentTitle_s" color="#817456">${contentModel.contentTitle_s!""}</@crafter.tag></h3>
